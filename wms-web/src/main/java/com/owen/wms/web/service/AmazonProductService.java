...
public class AmazonProductService {
	...
	public void write2Excel(List<JewelryEntity> list,String excelPath) throws Exception{ 
		...
		if("dresses".equals(list.get(0).getItemType())
				||"shorts".equals(list.get(0).getItemType())
				||"fashion-hoodies".equals(list.get(0).getItemType())
				||"music-fan-t-shirts".equals(list.get(0).getItemType())){
			templateFile =new ClassPathResource("template/ClothesTemplate.xls").getFile();		
		}else if("sunglasses".equals(list.get(0).getItemType())
				||"wallets".equals(list.get(0).getItemType())){
