								...
								<tr id="firstItem">
									...
									<td width="7%">
										<select class="notNullClass" id="list${status.index}.itemType"  name='list[${status.index}].itemType'>
												...
												<option value="fashion-hoodies" <c:if test="${ prod.itemType == 'fashion-hoodies' }" >selected="true"</c:if> >卫衣</option>
												<option value="sunglasses" <c:if test="${ prod.itemType == 'sunglasses' }" >selected="true"</c:if> >太阳镜</option>
												<option value="wallets" <c:if test="${ prod.itemType == 'wallets' }" >selected="true"</c:if> >钱包</option>
										</select>
									</td>
									<td width="7%">
